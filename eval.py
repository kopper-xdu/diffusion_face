...
def main(args):
    ...
    # dataset = Subset(dataset, [x for x in range(200)])
...
# 'l_ear', 'r_ear', 'mouth', 'u_lip', 'l_lip', 'hair', 'hat', 'ear_r', 'neck_l', 'neck', 'cloth']
                ...
                for x in range(batch_size):
                    save_image((result + 1) / 2, f'res/img/{i * batch_size + x}.png')
                    save_image((masked_image + 1) / 2, f'res/msk/{i * batch_size + x}_m.png')
